---
title: Arbeiten mit Assets für interne Bilder
description: 'Durchsuchen, Verwalten und Verwenden von Journey Optimizer B2B edition-Assets: Organisieren von Ordnern, Bearbeiten von Bildern und Erstellen von Inhalten für Account-Journey.'
...
Um auf interne Assets in Journey Optimizer B2B edition zuzugreifen, gehen Sie zum linken Navigationsbereich und klicken Sie auf **[!UICONTROL Content-Management]** > **[!UICONTROL Assets]**. Diese Aktion öffnet eine Listenseite mit allen aufgelisteten Assets.

![Durchsuchen von Bild-Assets](assets/assets-list-page.png){width="800" zoomable="yes"}
...
Auf der Listenseite _Assets_ können Sie Bild-Assets zum Journey Optimizer B2B edition Asset-Repository hinzufügen.
...
1. Ziehen Sie _[!UICONTROL Dialogfeld]_ Assets hinzufügen“ per Drag-and-Drop eine oder mehrere Dateien aus Ihrem System in das Feld „Datei“.
   ...
   ![Hinzufügen von Assets zu einem Ordner](./assets/assets-add-dialog.png){width="500"}
...
1. Wählen Sie den Zielordner zum Speichern der Assets aus.
...
Verwenden Sie eine der folgenden Methoden, um ein Asset zu löschen:
...
Verwenden Sie eine der folgenden Methoden, um ein Asset im Asset-Repository _[!UICONTROL Journey Optimizer B2B edition]_ zu ersetzen:
...
Sie können die folgenden Massenaktionen für ausgewählte Assets durchführen, die sich im Asset-Repository _[!UICONTROL Journey Optimizer B2B edition]_ befinden:
...
Sie können Aktionen auf einen Ordner oder Assets im Ordner anwenden. Klicken Sie auf das _Mehr_-Symbol (**…**) neben dem Ordner, um die Aktionen anzuzeigen, die Sie darauf anwenden können.
...
Wählen Sie in der visuellen Entwurfsleiste das Symbol _Assets_ ( ![Assets-Symbol](../../assets/do-not-localize/icon-assets-me.svg) ) in der linken Seitenleiste aus.

Durch diese Aktion wird das Bedienfeld Tools geändert, das eine Liste der verfügbaren Assets anzeigt. Es gibt mehrere Methoden zum Hinzufügen eines Bild-Assets zur visuellen Arbeitsfläche:

* Ziehen Sie eine Miniaturansicht per Drag-and-Drop aus dem linken Navigationsbereich.

* Fügen Sie eine Bildkomponente zur Arbeitsfläche hinzu und klicken Sie in der Komponente **[!UICONTROL Asset auswählen]** um das Dialogfeld _[!UICONTROL Asset auswählen]_ zu öffnen.
