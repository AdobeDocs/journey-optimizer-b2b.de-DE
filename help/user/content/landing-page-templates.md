...
![Zugriff auf die Landingpage-Vorlagenbibliothek und Filtern nach Namen](./assets/landing-page-templates-list-search.png){width="700" zoomable="yes"}
...
1. Geben Sie im Dialogfeld einen eindeutigen **[!UICONTROL Namen“ (erforderlich]** und einen nützlichen **[!UICONTROL Beschreibung]** (optional) ein.
   ...
   ![Geben Sie die anfänglichen Eigenschaften für die neue Landingpage-Vorlage ein](./assets/landing-page-templates-create-dialog.png){width="400"}
...
![Überprüfen Sie die Details zur Landingpage-Vorlage](./assets/template-details.png){width="700" zoomable="yes"}
...
* Die Auflistungsseite - Klicken Sie auf die Auslassungspunkte (**…**) neben einer Vorlage und wählen Sie **[!UICONTROL Bearbeiten]**.
...
* Klicken Sie auf der _[!UICONTROL Landingpage-]_) neben der Vorlage auf die Auslassungspunkte (…) und wählen Sie **[!UICONTROL Duplizieren]**.
...
* Klicken Sie auf der _Landingpage-Vorlagen_ auf die Auslassungspunkte (…) neben der Vorlage und wählen Sie **[!UICONTROL Löschen]**.
