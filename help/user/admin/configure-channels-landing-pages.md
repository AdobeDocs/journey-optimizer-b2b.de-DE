...
description: Konfigurieren Sie Landingpage-Subdomains und Voreinstellungen, damit Marketing-Experten Landingpages in Journey Optimizer B2B edition veröffentlichen können.
...
![Kanalkonfigurationen - Landingpage-Subdomains](./assets/config-channels-landing-pages-subdomains.png){width="800" zoomable="yes"}
...
1. Geben Sie die zu delegierende Subdomain an.
   ...
   ![Einrichten der Landingpage-Subdomain](./assets/config-channels-landing-pages-subdomain-setup.png){width="500" zoomable="yes"}
...
1. Stellen Sie sicher, dass der DNS-Eintrag in Ihrer Domain-Hosting-Lösung generiert wurde.
   ...
   ![Landingpage-Subdomain mit DNS-Einträgen eingerichtet](./assets/config-channels-landing-pages-subdomain-setup-dns.png){width="500" zoomable="yes"}
...
![Kanalkonfigurationen - Landingpage-Voreinstellungen](./assets/config-channels-landing-pages-presets.png){width="800" zoomable="yes"}
...
1. Eine Landingpage-Subdomain auswählen.
   ...
   ![Landingpage-Voreinstellung mit Namen, Beschreibung und Subdomain](./assets/config-channels-landing-pages-preset-create.png){width="500" zoomable="yes"}
...
1. Sie können die Landingpage-Subdomain für die **[!UICONTROL Tracking-URL]** auswählen, indem Sie die Option **[!UICONTROL Gleiche Subdomain wie Landingpage]** aktivieren.<!-- [Learn more about tracking](../email/message-tracking.md) -->
   ...
   ![Landingpage-Voreinstellung mit Subdomain-Einstellungen](./assets/config-channels-landing-pages-preset-subdomain-settings.png){width="500" zoomable="yes"}
