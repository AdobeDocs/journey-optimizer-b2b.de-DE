...
>[!NOTE]
>
>Ein Feld muss zunächst _verwaltet“_ kann dann _aktualisierbar_ werden. Die _aktualisierbaren Felder_ die Sie auswählen, müssen in Ihrem vom Benutzer bereitgestellten Schema vorhanden sein. Ihr Schema darf keine erforderlichen Felder enthalten, mit Ausnahme von systemdefinierten Feldern.
...
Weitere Informationen dazu, wie Sie die ausgewählten Felder für die erweiterte E-Mail-Personalisierung verwenden können, finden Sie unter [Inhaltspersonalisierung](../content/personalization.md#custom-datasets). Weitere Informationen dazu, wie Sie die ausgewählten Felder zum Journey-Decisioning verwenden können (Pfade nach Konto oder Personen aufteilen), finden Sie unter [Benutzerdefinierte Datenfilterung](../journeys/split-merge-paths-nodes.md#custom-data-filtering).
...
* Referenzschema: [B2B-Konto](https://experienceleague.adobe.com/de/docs/platform-learn/tutorials/schemas/create-schemas-for-b2b-data)
...
1. Klicken Sie **[!UICONTROL Relationales XDM-Schema auswählen]**.
   ...
   >[!NOTE]
   >
   >In dieser Beta-Funktionsversion werden nur _Benutzerdefinierte Objekte Konto und Personen - Viele-zu-eins_ unterstützt.
