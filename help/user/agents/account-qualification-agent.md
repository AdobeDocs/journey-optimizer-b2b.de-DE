---
title: Account Qualification Agent für B2B
...
Diese Lösung, die zusammen mit Adobe Journey Optimizer B2B (AJO B2B) und dem Adobe Agent Orchestrator-Framework erstellt wurde, integriert auf intelligente Weise Daten, Orchestrierung und generative KI-Funktionen, um Business Development Representatives (BDRs) mit den folgenden Fähigkeiten zu unterstützen:
...
* **Kundenanalyse**
  ...
  Durchführen von Account-Recherchen mit automatischem Abrufen und Anzeigen detaillierter Informationen über die Organisation eines potenziellen KundenZu diesen Informationen gehören wichtige Informationen zum Unternehmen, aktuelle Nachrichten, strategische Prioritäten und engagierte Top-Mitglieder.
...
Dieses intelligente Agentensystem verbessert die Skalierbarkeit, sorgt für eine kontextbezogene Sensibilisierung über Interaktionen hinweg und integriert sich nahtlos in die BDR-Toolchain - so können sich BDRs auf hochwertige Konversationen statt auf sich wiederholende Aufgaben konzentrieren.
