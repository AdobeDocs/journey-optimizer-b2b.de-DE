...
description: Der Sales Qualifier für Journey Optimizer B2B Prime bietet KI-Interessentenqualifizierung, ausgehende Workflows, CRM-Integration, Aufgaben und Profileinstellungen für BDRs.
...
Der Verkaufsqualifizierer ist in [!DNL Journey Optimizer B2B Prime] enthalten, aber es handelt sich um eine separate App innerhalb der Adobe Experience Platform.

![Startbildschirm des Sales Qualifier](../../user/agents/assets/home-screen.png){width="800" zoomable="yes"}
...
![Tabelle mit Interessenten, in der der Lead-Status und die letzte Aktivität für das Interessenten-Management angezeigt werden](../../user/agents/assets/prospects.png){width="800" zoomable="yes"}
...
![Registerkarte „Übersicht über ausgehende Workflows“](../../user/agents/assets/outbound-workflow-overview.png){width="800" zoomable="yes"}
...
1. Wählen Sie **[!UICONTROL Von Grund auf neu]**, um Ihr eigenes Ziel zu schreiben, oder **[!UICONTROL Von Vorlage starten]**, um eine gespeicherte Vorlage zu verwenden.
   ...
   ![Ausgehende Workflows von Grund auf neu erstellen](../../user/agents/assets/outbound-workflow-create-start-from-scratch.png){width="700" zoomable="yes"}
...
1. Klicken Sie auf den Abwärtspfeil, um die Liste **[!UICONTROL Filter hinzufügen]** anzuzeigen und einen anzuwendenden Filter auszuwählen.
   ...
   ![Erstellen von ausgehenden Workflow-Zielgruppenfiltern](../../user/agents/assets/outbound-workflow-create-targeting-filter-list.png){width="700" zoomable="yes"}

1. Legen Sie Werte für den Filter fest.

1. Fügen Sie weitere Filter hinzu, wenn Sie die Zielgruppe eingrenzen möchten.

   ![Ausgehenden Workflow erstellen - Zielgruppenbestimmung hat Filter mit Werten hinzugefügt](../../user/agents/assets/outbound-workflow-create-targeting-filters-values.png){width="600" zoomable="yes"}
...
![Vom ausgehenden Workflow generierte Touchpoint-Kadenz und Eingabeaufforderungen](../../user/agents/assets/outbound-workflow-create-touchpoints.png){width="700" zoomable="yes"}
...
![Einstellungen für ausgehende Workflows](../../user/agents/assets/outbound-workflow-create-settings.png){width="700" zoomable="yes"}
...
![Ausgehender Workflow - Interessenten hinzufügen](../../user/agents/assets/outbound-workflow-create-add-prospects.png){width="700" zoomable="yes"}
...
![Ausgehende Workflow-Prüfungsgenerierte E-Mails](../../user/agents/assets/outbound-workflow-create-review-generated-emails.png){width="700" zoomable="yes"}
...
![KI-Argumentation für ausgehende Workflows generierte E-Mails](../../user/agents/assets/outbound-workflow-create-review-generated-email-reasoning.png){width="600" zoomable="yes"}
...
1. Klicken Sie im E-Mail-Editor auf **[!UICONTROL Mit KI generieren]**.
   ...
   ![Verfeinerung ausgehender Workflows mit KI](../../user/agents/assets/outbound-workflow-create-review-generated-email-edit-regenerate.png){width="600" zoomable="yes"}
...
![Ausgehender Workflow - Interessenten auswählen und genehmigen](../../user/agents/assets/outbound-workflow-create-approve-enroll-prospects.png){width="700" zoomable="yes"}
...
![Aufgabenseite mit Aufgabenwarteschlange und Detailbereich](../../user/agents/assets/tasks.png){width="800" zoomable="yes"}
...
1. Erweitern Sie in der linken Navigation **[!UICONTROL Administration]** und wählen Sie **[!UICONTROL Integrationen]**.
   ...
   ![Seite Integrationen mit Salesforce- und Dynamics-Verbindungskarten](../../user/agents/assets/integrations-crm-connections.png){width="800" zoomable="yes"}
...
![Integrationen - Wissenszentrum](../../user/agents/assets/integrations-knowledge-center.png){width="700" zoomable="yes"}
...
![Registerkarte E-Mail-Einstellungen mit E-Mail-Verbindungsoptionen und E-Mail-Signaturkonfiguration](../../user/agents/assets/email-settings.png)
